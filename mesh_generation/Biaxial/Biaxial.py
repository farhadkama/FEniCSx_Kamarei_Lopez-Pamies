...
if make_mesh:
    ...
    if MPI.COMM_WORLD.rank == 0:
        gmsh.model.add("Biaxial")
        
        inner_cyl = gmsh.model.occ.addCylinder(0, 0, 0, 0, 0, B, r_cyl)

        # Step 2: Create box to cut out one-quarter (x >= 0 and y >= 0)
        box = gmsh.model.occ.addBox(0, 0, -1, r_cyl, r_cyl, B + 2)
        ...
        gmsh.model.setPhysicalName(3, group, "quarterbiaxial")
