...
if make_mesh:
    ...
    if MPI.COMM_WORLD.rank == 0:
        ...
        # Create outer box
        block = gmsh.model.occ.addBox(0, 0, 0, H, L, -B)
        ...
        gmsh.model.mesh.field.setNumber(field_id, "XMax", 2*H/3)
        gmsh.model.mesh.field.setNumber(field_id, "YMin",0)
        gmsh.model.mesh.field.setNumber(field_id, "YMax", 1)
        ...
        gmsh.model.mesh.field.setNumber(field2_id, "XMax", H)
        gmsh.model.mesh.field.setNumber(field2_id, "YMin", 0)
        gmsh.model.mesh.field.setNumber(field2_id, "YMax", L/3)
        ...
        gmsh.model.mesh.field.setNumber(field3_id, "VIn", 16* h)
        gmsh.model.mesh.field.setNumber(field3_id, "VOut", 32 * h)
        gmsh.model.mesh.field.setNumber(field3_id, "XMin", 0)
        gmsh.model.mesh.field.setNumber(field3_id, "XMax", H)
        gmsh.model.mesh.field.setNumber(field3_id, "YMin", 0)
        gmsh.model.mesh.field.setNumber(field3_id, "YMax", L/2)
